...
public class Player extends Entity{
	...
	// this determines where the player will be 
	...
	public Player(GamePanel gp, KeyHandler keyH) {
		...
		solidArea = new Rectangle();//x,y,width,height"RECTANGLE DIMENSION RELATIVE TO PLAYER SIZE
		solidArea.x =8; //record this before change it
		solidArea.y =16;
	...
	public void update() {
	  ...
	  int objIndex =  gp.cChecker.chickObject(this,true);
